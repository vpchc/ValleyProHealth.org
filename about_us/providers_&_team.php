...
<main>
    ...
    <a href="#physicians"><button class="sidebar-section large">Physicians</button></a>
    ...
    <a href="#sitemanagers"><button class="sidebar-section large">Site Managers</button></a>
  </div>
  <div class="banner">
    <img src="/images/banner/about_us_team.jpg">
  ...
  <div class="content centered small">
    ...
    <div class="tab">
      ...
      <div class="tab-box">
		...
		<div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Dr. Patrick Foley, MD</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Dr. Foley enjoys reading, biking, traveling, water sports and being outdoors.  He chose to work at Valley Professionals because he believes in our mission of integrated care where the patient's needs come first.</p>
          </div>
    ...
    <div class="tab">
      ...
      <div class="tab-box">
        <img src="/images/providers/gale.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Physician</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>Ball State University - BS Physiology</li>
							<li>Indiana University School of Medicine - Doctor of Medicine</li>
						</ul>
						<p class="tab-title">Personal</p>
						<p>Dr. Gale has been practicing in the area for over fifteen years. She enjoys focusing on patient care and creating a happier and healthier community.</p>
          </div>
          <p class="tab-location">Currently providing care in Clinton and Cayuga</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Dr. Steven Waltz, MD</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Dr. Waltz has been practicing medicine in the Wabash Valley for over 30 years. He enjoys teaching and mentoring other primary care providers in his role as Chief Medical Officer at Valley Professionals, as well as continuing to provide excellent care to his patients in Rockville.</p>
          </div>
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Leslie is married with 2 daughters. She is active in her church, enjoys spending time with her family, watching her daughters in their many sporting events, and photography.</p>
          </div>
		...
		<div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Jessica Bekkering, FNP-C</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Jessica began her journey in medical field 16 years ago as medic in the Air Force. She was born and raised in Dana, IN and after several years and many moves she is excited to be settled back and providing care close to her hometown.</p>
          </div>
          <p class="tab-location">Currently providing care in Crawfordsville</p>
        </div>
      </div>
    ...
    <div class="tab">
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>Indiana University - MSN</li>
							<li>Purdue University - BSN</li>
						</ul>
						<p class="tab-title">Personal</p>
						<p>Christi enjoys spending time with her four children and family. She is an avid reader and also enjoys photography.</p>
          </div>
          <p class="tab-location">Currently providing care in Bloomingdale and Mobile Health Center</p>
        </div>
      </div>
    </div><div class="tab">	
      <div class="tab-bar blue">
      ...
      <div class="tab-box">
        <img src="/images/providers/fields.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>MSN - Indiana State University</li>
							<li>BSN - Indiana Wesleyan University</li>
						</ul>
						<p class="tab-title">Personal</p>
						<p>Beth considers it an honor and a privilege to care for persons who entrust her with their healthcare needs. In her free time she enjoys spending time with her family, gardening, and travel.</p>
          </div>
          <p class="tab-location">Currently providing care in Terre Haute</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Nicole Hall, FNP-C</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/hall.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						...
						<p class="tab-title">Personal</p>
						<p>Nicole Hall is committed to her patients and holistic care. She enjoys running, shopping, and serving her country in the Indiana Air National Guard.</p>
          </div>
          <p class="tab-location">Currently providing care in Clinton</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Brandi Larson, FNP-C</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/larson.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						...
						<p class="tab-title">Personal</p>
						<p> Brandi is originally from Reno Nevada born and raised. She has been in Indiana since 2006. Brandi enjoys working out and spending time with her two beautiful children. She is devoted to country and serves in the Air National Guard. She is passionate about holistic preventative patient care.</p>
          </div>
          <p class="tab-location">Currently providing care in Clinton</p>
        </div>
      </div>
    ...
    <div class="tab">
      ...
      <div class="tab-box">
        <img src="/images/providers/mundy.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						...
						<p class="tab-title">Personal</p>
						<p>In addition to practicing medicine, Tammy enjoys traveling, reading and visiting antique shops. Tammy is married with 2 children and one grandchild.</p>
          </div>
          <p class="tab-location">Currently providing care in Clinton</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Renae Norman, FNP-C</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/norman.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						...
						<p class="tab-title">Personal</p>
						<p>In addition to practicing medicine, Renae enjoys reading and spending time with her husband and their three children. Renae's children are very active in athletics, therefore she spends a lot of time supporting the North Vermillion Falcons.</p>
          </div>
          <p class="tab-location">Currently providing care in Cayuga and Mobile Health Center</p>
        </div>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Tammy Pearson, FNP-C</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Tammy has always had a passion for caring for others. She is married and has 2 grown children, as son and a daughter. She enjoys spending time with her family and her special fur baby dog, Dodger.</p>
          </div>
          <p class="tab-location">Currently providing care in Terre Haute</p>
        </div>
      </div>
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>As a lifelong resident of Parke county, Brandie looks forward to serving the healthcare needs of the community she calls home. Brandie enjoys time with family, traveling, hiking, gardening and has a general love for nature.</p>
          </div>
          <p class="tab-location">Currently providing care in Rockville</p>
        </div>
      </div>
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Jordan’s favorite part of working for Valley Professionals in Rockville is knowing that she is a part of the solution to the shortage of rural health providers. She also enjoys the connection that she has with the patients, coming from a small town herself. Jordan enjoys traveling and all things outdoors, especially hiking and gardening.</p>
          </div>
          <p class="tab-location">Currently providing care in Rockville</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Louwanna Wallace, FNP-C</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/wallace.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>Indiana State University - MSN, BSN</li>
							<li>University of Indianapolis - ASN</li>
						</ul>
						<p class="tab-title">Personal</p>
						<p>Louwanna has been in the healthcare field more than 40 years and enjoys providing health care in a rural clinic setting In her free time, she enjoys spending time with family, hunting, reading, and music.</p>
          </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Dr. Paul Taraska, MD</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/taraska.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Psychiatrist</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>Indiana University School of Medicine</li>
						...
						<p class="tab-title">Personal</p>
						<p>Dr. Taraska is passionate about providing behavorial healthcare for the patients of VPCHC.</p>
          </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Dr. Julia Wernz, PhD, HSPP</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/wernz.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Psychologist</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Misha believes therapy works best when it is a collaborative process and she enjoys watching clients reach or exceed their personal goals. In her spare time, she enjoys travel, hiking, local festivals and spending time with friends and family, which includes her geriatric cat.</p>
          </div>
          <p class="tab-location">Currently providing care in Crawfordsville</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Linda Lonneman, LCSW</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Linda is married and has two children, three granddaughters, and two stepdaughters. She enjoys spending time with family and friends, cycling and outdoor activities, traveling, and caring for her animals.</p>
          </div>
          <p class="tab-location">Currently providing care in Clinton</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">David McIntyre, LCAC</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/mcintyre.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Licensed Clinical<br>Addictions Counselor</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Zac Milam, LMHC</p>
      </div>
      <div class="tab-box">
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Sara Ritter, LCSW</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Sara has an LCSW as well as her LCAC (Licensed Clinical Addictions Counselor) and has been working in the field of mental health and addictions for over 30 years. She enjoys working with people of all ages and treatment concerns. During her time away from work, Sara enjoys reading, being outside, taking vacations, and spending time with friends and family.</p>
          </div>
          <p class="tab-location">Currently providing care in Terre Haute</p>
        </div>
      </div>
    ...
    <div class="tab">
      ...
      <div class="tab-box">
        <img src="/images/providers/skwortz.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Licensed Clinical<br>Social Worker</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Tasha Lewis-Stevens, RN, LCSW</p>
      </div>
      <div class="tab-box">
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Lisa Tincher, PMHNP</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>Stony Brook University - Post-Masters</li>
							<li>Indiana State University - MS</li>
							<li>Indiana Wesleyan University - BS</li>
						</ul>
						<p class="tab-title">Personal</p>
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Dana Tinkle, LMHC, RPT</p>
      </div>
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Dana works with clients of all ages and mental health concerns, and has a strong clinical interest in childhood trauma treatment. Dana is married and enjoys traveling with her husband. Her hobbies include reading, fitness classes, and listening to music. She also loves to spend time with her friends and family.</p>
          </div>
          <p class="tab-location">Currently providing care in Crawfordsville</p>
        </div>
      </div>
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          ...
          <div class="tab-bio">
						...
						<p class="tab-title">Personal</p>
						<p>Heather is currently working towards becoming a Registered Play Therapist. Her favorite part of working on the Mobile School-Based Health Center is having the ability to provide services to children and adolescents who may otherwise not be able to receive behavioral healthcare, as well as, the privilege of working and collaborating with some wonderful members of the school staff. Heather enjoys spending her free-time with family and friends. She also enjoys crafting, decorating, listening to music, learning new things, and playing with her two dogs.</p>
          </div>
          <p class="tab-location">Currently providing care through school-based services</p>
        </div>
      </div>
    ...
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Terry Warren<span>Chief Executive Officer</span></p>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar grey">
    ...
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Scott Andritsch<span>Chief Financial Officer</span></p>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar grey">
    ...
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Stephanie Jeffery<span>Quality & Risk Management</span></p>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Amy Reed<span>Director of Development</span></p>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar grey">
    ...
    <h3 id="sitemanagers">Site Managers</h3>
    <hr>
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Devan Busenbark<span>Clinton</span></p>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar grey">
    ...
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Melissa Caldwell<span>Rockville/Mobile Unit</span></p>
      </div>
    </div>
    <div class="tab">
      <div class="tab-bar grey">
        <p class="tab-simple">Theresa Underwood<span>Terre Haute</span></p>
      </div>
    </div>		<div class="tab">      <div class="tab-bar grey">        <p class="tab-simple">Josie Sanders<span>Bloomingdale/Cayuga</span></p>      </div>    </div>
  </div>
</main>
