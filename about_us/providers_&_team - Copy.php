...
<main>
  ...
  <div class="content centered small">
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Nicole Cook, FNP-C</p>
      </div>
      <div class="tab-box">
        <img src="/images/providers/cook.jpg">
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
							<li>Southern Illinois University Edwardsville - BSN</li>
							<li>St. Louis University School of Nursing - MSN</li>
						</ul>
						<p class="tab-title">Personal</p>
						<p>Nicole says her favorite part of working on the Mobile Health Unit is being able to provide healthcare services to children who may not normally receive healthcare as well as working with the wonderful school staff. In her free time, she enjoys spending time with her husband and daughter. Originally from the St. Louis area, Nicole is an avid St. Louis Cardinals fan.</p>
          </div>
          <p class="tab-location">Currently providing care in Mobile School-Based Health Center</p>
        </div>
      </div>
    </div>
    <div class="tab">
    ...
    <div class="tab">
      <div class="tab-bar blue">
        <p class="tab-name">Tasha Lewis-Stevens, LCSW, RN</p>
      </div>
      <div class="tab-box">
    ...
    <div class="tab">
      ...
      <div class="tab-box">
        ...
        <div class="tab-box-text">
          <div class="tab-credentials"><p>Psychiatric<br>-Mental Health<br>Nurse Practitioner</p></div>
          <div class="tab-bio">
						<p class="tab-title">Education</p>
						<ul>
    ...
    <h3 id="pcc">Patient Care Coordinators</h3>
    <hr>
    <div class="tab">
      <div class="tab-bar green">
