...
<main>
	<h5>News Archive</h5>
	<h6>Community Health Workers Join VPCHC to Assist with Insurance Enrollment</h6>
	<h6>October 1, 2013</h6>
	<div class="archive-section">
		...
		<li>Assist individuals/families in navigating through the Insurance Marketplace</li>
		<li>Connect patients to local resources in the community</li>
		<li>Counsel patients on preventive health care behaviors</li>
		<li>Reduce unnecessary hospital readmissions</li>
		<li>Compliment the Patient Center Medical Home Model</li>
		<p>The CHWs will be in the community in many locations such as our VPCHC&rsquo;s three health centers in Clinton, Cayuga, and Bloomingdale, as well as the Mobile Health Center, county courthouses, and local libraries. Additional places may include: Union Hospital (Clinton), Rockville Learning Center, local food banks, sporting activities, and many other events in and around the community. Please visit the website localhelp.healthcare.gov for assistance in your area or feel free to contact the VPCHC Community Health Workers:</p>
		<p>Devan Busenbark &#8212; dbusenbark@vpchc.org</p>
		<p>Candice Wilson &#8212; cwilson@vpchc.org</p>
		<p>Nikki Varwig &#8212; nvarwig@vpchc.org</p>
		<p>Becky Shepard &#8212; rshepard@vpchc.org</p>
	</div>
</main>
