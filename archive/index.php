...
<main id="masterbox">
  <h1>Archive</h1>
  <h2>Choose a section of the archive</h2>
  <div id="archive-options">
    <a href="/archive/news/"><button class="vpchcbutton">News</button></a>
    <a href="/archive/photos/"><button class="vpchcbutton">Photos</button></a>
  </div>
</main>
