...
<main id="masterbox">
  <h1>News Archive</h1>
  <h2>VPCHC Physician Position Description</h2>
  <h3 id="page-tinytitle">January 13, 2014</h3>
  <div id="archive-news-section">
    ...
    <p>Physicians at VPCHC are currently on call one in five weekends.  Inpatients are covered by a hospitalist arrangement with Union Hospital Clinton, a local Critical Access Hospital, meaning that call is typically quite light.  Physicians report directly to Dr. Eric Beachy, VPCHC&rsquo;s Chief Medical Officer and indirectly to Elizabeth Burrows, VPCHC&rsquo;s Chief Executive Officer.</p>
    <p>VPCHC places a premium on work-life balance with generous holiday and Paid Time Off allowances.   A competitive salary and benefits package is offered.   Continuing Medical Education is encouraged through monetary and time CME allowances (in addition to the PTO).  Several current clinicians have successfully qualified for loan repayment through the National Health Service Corps.</p>
  </div>
</main>
