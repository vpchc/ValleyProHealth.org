...
<main id="masterbox">
  ...
  <div id="forms-content-options">
    ...
    <button id="forms-options-other" class="vpchcbutton">Other Forms</button>
    <button id="forms-options-spanish" class="vpchcbutton">Espa&ntilde;ol</button> 
    <a href="/resources/forms/simple_list.php">Buttons not working? Try clicking here instead for a simple list of forms.</a>
  </div>
  <div id="forms-content-clinic">
    ...
    <table id="forms-content-clinic-table" class="forms-table-location">
      <tr>
        <td><img id="forms-content-clinic-bloom" class="forms-table-pics" src="/images/bloomingdale_location.jpg" alt="Bloomingdale Choice"/></td>
        <td class="forms-clinic-table-mobilename">Bloomingdale</td>
        <td><img id="forms-content-clinic-cay" class="forms-table-pics" src="/images/cayuga_location.jpg" alt="Cayuga Choice"/></td>
        <td class="forms-clinic-table-mobilename">Cayuga</td>
        <td><img id="forms-content-clinic-clint" class="forms-table-pics" src="/images/clinton_location.jpg" alt="Clinton Choice"/></td>
