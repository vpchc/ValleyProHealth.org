...
$maintxt = '<div id="location">' . $mainrow[location] . '</div>' . 
    '<div id="hours">' . $mainrow[hours] . '</div>' .
    '<div id="start">' . $mainrow[start_time] . '</div>' .
    '<div id="end">' . $mainrow[end_time] . '</div>';
...
if ($flagsection[flag] == 1) {
    ...
    if(!fwrite($busScheduleFile, $subtxt)){
        echo 'Unsuccessful sub write in appfile...' . '<br>';
    }
    $subtxt = '<div id="location">' . $subrow[location] . '</div>' . 
    '<div id="hours">' . $subrow[hours] . '</div>' .
    '<div id="start">' . $subrow[start_time] . '</div>' .
    '<div id="end">' . $subrow[end_time] . '</div>';
