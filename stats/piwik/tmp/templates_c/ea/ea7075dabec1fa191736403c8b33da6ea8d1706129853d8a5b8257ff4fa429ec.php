...
class __TwigTemplate_ea877098f56f483da286208b9a960b05041cc2aa3552e0a801c3f9ae323d8de9 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (((array_key_exists("showLocation", $context)) ? (_twig_default_filter((isset($context["showLocation"]) ? $context["showLocation"] : $this->getContext($context, "showLocation")), false)) : (false))) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "location", array()), "html", null, true);
            echo "\">
    <img src=\"";
            // line 9
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "countryFlag", array()), "html", null, true);
            echo "\"/>&nbsp;<span>";
            if ( !twig_test_empty($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "city", array()))) {
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "city", array()), "html", null, true);
            } else {
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "country", array()), "html", null, true);
            }
            echo "</span>
</div>
";
    ...
    <ul>
        ...
        if (($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "providerName", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "providerName", array())))) {
            ...
            echo ": ";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "providerName", array()), "html", null, true);
            echo "\"";
        }
        echo ">";
        echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "visitIp", array()), "html", null, true);
        echo "</strong>
        </li>
        ...
        if (array_key_exists("widgetizedLink", $context)) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, (isset($context["widgetizedLink"]) ? $context["widgetizedLink"] : $this->getContext($context, "widgetizedLink")), "html", null, true);
            ...
            echo \Piwik\piwik_escape_filter($this->env, twig_upper_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_Id"))), "html", null, true);
            echo " ";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "visitorId", array()), "html", null, true);
            echo "\">";
        }
        // line 20
        echo "                <strong>";
        ...
        echo \Piwik\piwik_escape_filter($this->env, (isset($context["exportLink"]) ? $context["exportLink"] : $this->getContext($context, "exportLink")), "html", null, true);
        echo "\" target=\"_blank\" title=\"";
        ...
        if ($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "browserName", array(), "any", true, true)) {
            ...
            if ( !$this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "plugins", array(), "any", true, true)) {
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browser", array()), "html", null, true);
                ...
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("DevicePlugins_BrowserWithNoPluginsEnabled", $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browser", array()))), "html", null, true);
            }
            echo "\">
                ";
            // line 29
            if ($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "browserIcon", array(), "any", true, true)) {
                echo "<img src=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browserIcon", array()), "html", null, true);
                echo "\"/>";
            }
            echo "<span>";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute(twig_split_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browserName", array()), " "), 0, array(), "array"), "html", null, true);
            echo "</span>
            </div>
            ";
        }
        ...
        if ($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "operatingSystemIcon", array(), "any", true, true)) {
            echo "<img src=\"";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "operatingSystemIcon", array()), "html", null, true);
            echo "\"/>";
        }
        if ($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "operatingSystem", array(), "any", true, true)) {
            echo "<span>";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "operatingSystem", array()), "html", null, true);
            echo "</span>";
        }
        // line 35
        echo "            </div>
        ...
        if ($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "resolution", array(), "any", true, true)) {
            ...
            echo "</span><strong>";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "resolution", array()), "html", null, true);
            echo "</strong></li>";
        }
        // line 38
        echo "        ";
        ...
        if (array_key_exists("visitReferralSummary", $context)) {
            ...
            echo ">";
            echo \Piwik\piwik_escape_filter($this->env, (isset($context["visitReferralSummary"]) ? $context["visitReferralSummary"] : $this->getContext($context, "visitReferralSummary")), "html", null, true);
            echo "</strong>
        </li>
        ";
        }
...
";
    ...
    public function getcustomVar($__id__ = null, $__customVariable__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 4
            echo "    <li><span>";
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('truncate')->getCallable(), array($this->getAttribute((isset($context["customVariable"]) ? $context["customVariable"] : $this->getContext($context, "customVariable")), (isset($context["name"]) ? $context["name"] : $this->getContext($context, "name")), array(), "array"), 30)), "html", null, true);
            echo "</span>";
