...
class __TwigTemplate_452cf8c738d9d978362c4d84db872e7b1084b4e858b489660328852497d11e96 extends Twig_Template
{
    ...
    data-graph-id=\"";
        // line 2
        echo \Piwik\piwik_escape_filter($this->env, (isset($context["nameGraphEvolutionReferrers"]) ? $context["nameGraphEvolutionReferrers"] : $this->getContext($context, "nameGraphEvolutionReferrers")), "html", null, true);
        echo "\">";
...
<h2 piwik-enriched-headline>";
        // line 5
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_Type")), "html", null, true);
        echo "</h2>
...
<div class=\"row\">
    <div class=\"col-md-6\">
        ...
        echo "
            ";
        // line 10
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_TypeDirectEntries", (("<strong>" . call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["visitorsFromDirectEntry"]) ? $context["visitorsFromDirectEntry"] : $this->getContext($context, "visitorsFromDirectEntry"))))) . "</strong>")));
        echo "
            ";
        // line 11
        if ( !twig_test_empty(((array_key_exists("visitorsFromDirectEntryPercent", $context)) ? (_twig_default_filter((isset($context["visitorsFromDirectEntryPercent"]) ? $context["visitorsFromDirectEntryPercent"] : $this->getContext($context, "visitorsFromDirectEntryPercent")))) : ("")))) {
            echo ",
                ";
            // line 12
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_XPercentOfVisits", (("<strong>" . call_user_func_array($this->env->getFilter('percent')->getCallable(), array((isset($context["visitorsFromDirectEntryPercent"]) ? $context["visitorsFromDirectEntryPercent"] : $this->getContext($context, "visitorsFromDirectEntryPercent"))))) . "</strong>")));
            echo "
            ";
        }
        // line 14
        ...
        echo "
            ";
        // line 19
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_TypeSearchEngines", (("<strong>" . call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["visitorsFromSearchEngines"]) ? $context["visitorsFromSearchEngines"] : $this->getContext($context, "visitorsFromSearchEngines"))))) . "</strong>")));
        echo "
            ";
        // line 20
        if ( !twig_test_empty(((array_key_exists("visitorsFromSearchEnginesPercent", $context)) ? (_twig_default_filter((isset($context["visitorsFromSearchEnginesPercent"]) ? $context["visitorsFromSearchEnginesPercent"] : $this->getContext($context, "visitorsFromSearchEnginesPercent")))) : ("")))) {
            echo ",
                ";
            // line 21
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_XPercentOfVisits", (("<strong>" . call_user_func_array($this->env->getFilter('percent')->getCallable(), array((isset($context["visitorsFromSearchEnginesPercent"]) ? $context["visitorsFromSearchEnginesPercent"] : $this->getContext($context, "visitorsFromSearchEnginesPercent"))))) . "</strong>")));
            echo "
            ";
        }
        // line 23
    ...
    <div class=\"col-md-6\">
        ...
        echo "
            ";
        // line 30
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_TypeWebsites", (("<strong>" . call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["visitorsFromWebsites"]) ? $context["visitorsFromWebsites"] : $this->getContext($context, "visitorsFromWebsites"))))) . "</strong>")));
        echo "
            ";
        // line 31
        if ( !twig_test_empty(((array_key_exists("visitorsFromWebsitesPercent", $context)) ? (_twig_default_filter((isset($context["visitorsFromWebsitesPercent"]) ? $context["visitorsFromWebsitesPercent"] : $this->getContext($context, "visitorsFromWebsitesPercent")))) : ("")))) {
            echo ",
                ";
            // line 32
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_XPercentOfVisits", (("<strong>" . call_user_func_array($this->env->getFilter('percent')->getCallable(), array((isset($context["visitorsFromWebsitesPercent"]) ? $context["visitorsFromWebsitesPercent"] : $this->getContext($context, "visitorsFromWebsitesPercent"))))) . "</strong>")));
            echo "
            ";
        }
        // line 34
        ...
        echo "
            ";
        // line 39
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_TypeCampaigns", (("<strong>" . call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["visitorsFromCampaigns"]) ? $context["visitorsFromCampaigns"] : $this->getContext($context, "visitorsFromCampaigns"))))) . "</strong>")));
        echo "
            ";
        // line 40
        if ( !twig_test_empty(((array_key_exists("visitorsFromCampaignsPercent", $context)) ? (_twig_default_filter((isset($context["visitorsFromCampaignsPercent"]) ? $context["visitorsFromCampaignsPercent"] : $this->getContext($context, "visitorsFromCampaignsPercent")))) : ("")))) {
            echo ",
                ";
            // line 41
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_XPercentOfVisits", (("<strong>" . call_user_func_array($this->env->getFilter('percent')->getCallable(), array((isset($context["visitorsFromCampaignsPercent"]) ? $context["visitorsFromCampaignsPercent"] : $this->getContext($context, "visitorsFromCampaignsPercent"))))) . "</strong>")));
            echo "
            ";
        }
        // line 43
...
<div id=\"distinctReferrersByType\" class=\"row\">
    <div class=\"col-md-6\">
        ...
        echo "
            <strong>";
        // line 53
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["numberDistinctSearchEngines"]) ? $context["numberDistinctSearchEngines"] : $this->getContext($context, "numberDistinctSearchEngines")))), "html", null, true);
        echo "</strong> ";
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_DistinctSearchEngines")), "html", null, true);
        echo "
            ";
        // line 54
        ...
        echo "
            <strong>";
        // line 59
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["numberDistinctKeywords"]) ? $context["numberDistinctKeywords"] : $this->getContext($context, "numberDistinctKeywords")))), "html", null, true);
        echo "</strong> ";
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_DistinctKeywords")), "html", null, true);
        echo "
            ";
        // line 60
    ...
    <div class=\"col-md-6\">
        ...
        echo "
            <strong>";
        // line 67
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["numberDistinctWebsites"]) ? $context["numberDistinctWebsites"] : $this->getContext($context, "numberDistinctWebsites")))), "html", null, true);
        echo "</strong> ";
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_DistinctWebsites")), "html", null, true);
        echo "
            ";
        // line 68
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_UsingNDistinctUrls", (("<strong>" . call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["numberDistinctWebsitesUrls"]) ? $context["numberDistinctWebsitesUrls"] : $this->getContext($context, "numberDistinctWebsitesUrls"))))) . "</strong>")));
        echo "
            ";
        // line 69
        ...
        echo "
            <strong>";
        // line 74
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('number')->getCallable(), array((isset($context["numberDistinctCampaigns"]) ? $context["numberDistinctCampaigns"] : $this->getContext($context, "numberDistinctCampaigns")))), "html", null, true);
        echo "</strong> ";
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_DistinctCampaigns")), "html", null, true);
        echo "
            ";
        // line 75
...
<div style=\"float:left;\" class=\"relatedReferrerReports\">";
        // line 83
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_View")), "html", null, true);
        echo "
    <a href=\"javascript:broadcast.propagateAjax('module=Referrers&action=getSearchEnginesAndKeywords')\">";
        // line 84
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_SubmenuSearchEngines")), "html", null, true);
        echo "</a>,
    <a href=\"javascript:broadcast.propagateAjax('module=Referrers&action=indexWebsites')\">";
        // line 85
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_SubmenuWebsites")), "html", null, true);
        echo "</a>,
    <a href=\"javascript:broadcast.propagateAjax('module=Referrers&action=indexCampaigns')\">";
        // line 86
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Referrers_Campaigns")), "html", null, true);
        echo "</a>.
</div>
