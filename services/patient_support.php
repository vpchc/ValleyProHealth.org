  ...
  <div id="banner">
    ...
    <div id="banner-right">
      <div id="iconbanner-title" class="iconbanner-title-ps">
        <img id="iconbanner-title-icon" class="iconbanner-ps" src="/images/ps_icon.png" alt="Patient Support Icon"/>
        <h1 id="iconbanner-title-word" class="iconbanner-word-ps vpchcgreen">Patient Support</h1>
      </div>
    </div>
  </div>
  <div id="explain-content">
    <p class="explain-title vpchcblue">Community Health Workers</p>
    ...
    <p class="explain-subtitle vpchcblue">Get covered</p>
    ...
    <p class="explain-subtitle vpchcblue">Get connected</p>
    <p class="explain-p">CHWs can help patients locate necessary resources such as food, transportation or housing.</p>
    <p class="explain-title vpchcblue">Patient Care Coordinators</p>
    ...
    <p class="explain-subtitle vpchcblue">Take Control</p>
    <p class="explain-p">Take control of your health and gain independence.  Work with a Patient Care Coordinator to create a treatment plan that works for you.</p>
    <p class="explain-subtitle vpchcblue">Learn</p>
